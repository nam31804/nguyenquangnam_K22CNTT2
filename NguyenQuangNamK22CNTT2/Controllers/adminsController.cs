...
namespace NguyenQuangNamK22CNTT2.Controllers
{
    public class adminsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "admin_id,username,password")] admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "admin_id,username,password")] admin admin)
        {
            if (ModelState.IsValid)
            {
